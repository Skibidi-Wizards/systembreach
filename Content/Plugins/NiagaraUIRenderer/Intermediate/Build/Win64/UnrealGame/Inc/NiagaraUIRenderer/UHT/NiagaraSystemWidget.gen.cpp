...
FClassRegistrationInfo Z_Registration_Info_UClass_UNiagaraSystemWidget;
UClass* UNiagaraSystemWidget::GetPrivateStaticClass()
{
	using TClass = UNiagaraSystemWidget;
	if (!Z_Registration_Info_UClass_UNiagaraSystemWidget.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("NiagaraSystemWidget"),
			Z_Registration_Info_UClass_UNiagaraSystemWidget.InnerSingleton,
			StaticRegisterNativesUNiagaraSystemWidget,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UNiagaraSystemWidget.InnerSingleton;
}
UClass* Z_Construct_UClass_UNiagaraSystemWidget_NoRegister()
{
	return UNiagaraSystemWidget::GetPrivateStaticClass();
}
struct Z_Construct_UClass_UNiagaraSystemWidget_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UNiagaraSystemWidget_ActivateSystem, "ActivateSystem" }, // 38309526
		{ &Z_Construct_UFunction_UNiagaraSystemWidget_DeactivateSystem, "DeactivateSystem" }, // 388176160
		{ &Z_Construct_UFunction_UNiagaraSystemWidget_GetNiagaraComponent, "GetNiagaraComponent" }, // 1285700407
		{ &Z_Construct_UFunction_UNiagaraSystemWidget_GetRemapMaterial, "GetRemapMaterial" }, // 2418603900
		{ &Z_Construct_UFunction_UNiagaraSystemWidget_SetColorAndOpacity, "SetColorAndOpacity" }, // 2121490159
		{ &Z_Construct_UFunction_UNiagaraSystemWidget_SetDesiredWidgetSize, "SetDesiredWidgetSize" }, // 1828446500
		{ &Z_Construct_UFunction_UNiagaraSystemWidget_SetRemapMaterial, "SetRemapMaterial" }, // 2684624581
		{ &Z_Construct_UFunction_UNiagaraSystemWidget_UpdateNiagaraSystemReference, "UpdateNiagaraSystemReference" }, // 3625510778
		{ &Z_Construct_UFunction_UNiagaraSystemWidget_UpdateTickWhenPaused, "UpdateTickWhenPaused" }, // 2225031626
	};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraSystemWidget_h__Script_NiagaraUIRenderer_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraSystemWidget, UNiagaraSystemWidget::StaticClass, TEXT("UNiagaraSystemWidget"), &Z_Registration_Info_UClass_UNiagaraSystemWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraSystemWidget), 3774093001U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraSystemWidget_h__Script_NiagaraUIRenderer_3969558104(TEXT("/Script/NiagaraUIRenderer"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraSystemWidget_h__Script_NiagaraUIRenderer_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraSystemWidget_h__Script_NiagaraUIRenderer_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
