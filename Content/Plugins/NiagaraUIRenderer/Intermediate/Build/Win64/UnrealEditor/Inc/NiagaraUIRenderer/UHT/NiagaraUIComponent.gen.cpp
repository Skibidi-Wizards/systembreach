...
FClassRegistrationInfo Z_Registration_Info_UClass_UNiagaraUIComponent;
UClass* UNiagaraUIComponent::GetPrivateStaticClass()
{
	using TClass = UNiagaraUIComponent;
	if (!Z_Registration_Info_UClass_UNiagaraUIComponent.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("NiagaraUIComponent"),
			Z_Registration_Info_UClass_UNiagaraUIComponent.InnerSingleton,
			StaticRegisterNativesUNiagaraUIComponent,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UNiagaraUIComponent.InnerSingleton;
}
UClass* Z_Construct_UClass_UNiagaraUIComponent_NoRegister()
{
	return UNiagaraUIComponent::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_HostProject_Plugins_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraUIComponent_h__Script_NiagaraUIRenderer_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraUIComponent, UNiagaraUIComponent::StaticClass, TEXT("UNiagaraUIComponent"), &Z_Registration_Info_UClass_UNiagaraUIComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraUIComponent), 3759062700U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraUIComponent_h__Script_NiagaraUIRenderer_459400503(TEXT("/Script/NiagaraUIRenderer"),
	Z_CompiledInDeferFile_FID_HostProject_Plugins_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraUIComponent_h__Script_NiagaraUIRenderer_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_NiagaraUIRenderer_Source_NiagaraUIRenderer_Public_NiagaraUIComponent_h__Script_NiagaraUIRenderer_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
